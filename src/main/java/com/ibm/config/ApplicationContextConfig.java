...
/*
	...
	public DataSource getDataSource() {
        ...
        dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
        dataSource.setUrl("jdbc:mysql://" + System.getenv("localhost") + ":3306/" + System.getenv("shan")
		+"?verifyServerCertificate=false&useSSL=false&requireSSL=false");

//        dataSource.setUrl("jdbc:mysql://localhost:3306/shan");
        dataSource.setUsername("sandy");
	...
	*/
		...
		dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
		dataSource.setUrl("jdbc:mysql://localhost:3306/nht"
				+"?verifyServerCertificate=false&useSSL=false&requireSSL=false");
